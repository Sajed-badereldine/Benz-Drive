...
resource "aws_subnet" "public" {
  ...
  tags = {
    Name = "benzdrive-public-${count.index}"
  }
}
...
resource "aws_vpc_endpoint" "s3" {
  ...
  tags = {
    Name = "benzdrive-s3-endpoint"
  }
}

# Elastic IP for NAT Gateway (to allow private subnets internet access, e.g. for SMTP/External APIs)
